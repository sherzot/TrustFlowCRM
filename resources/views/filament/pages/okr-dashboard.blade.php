        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            @foreach ($this->getObjectives() as $key => $objective)
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    <h3 class="font-semibold text-lg mb-4 text-gray-900 dark:text-gray-100 capitalize">
                        {{ str_replace('_', ' ', $key) }}
                    </h3>
                    <div class="space-y-4">
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-gray-600 dark:text-gray-400">現在の値:</span>
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-gray-600 dark:text-gray-400">目標:</span>
                            <span class="font-semibold text-gray-900 dark:text-gray-100">
                                @if (str_contains($key, 'value') || str_contains($key, 'revenue'))
                        ...
                        <div class="mt-4">
                            <div class="flex justify-between items-center mb-2">
                                <span class="text-sm text-gray-600 dark:text-gray-400">進捗:</span>
