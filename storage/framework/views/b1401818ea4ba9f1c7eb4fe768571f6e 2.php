...
<head>
    ...
    <title><?php echo e(__('filament.project')); ?> - <?php echo e($project->name); ?></title>
    <style>
        <?php
...
<body>
    <div class="header">
        <h1><?php echo e(__('filament.project')); ?></h1>
    </div>

    <div class="project-info">
        <div class="info-row">
            <div class="info-label"><?php echo e(__('filament.name')); ?>:</div>
        ...
        <div class="info-row">
            <div class="info-label"><?php echo e(__('filament.start_date')); ?>:</div>
        ...
        <div class="info-row">
            <div class="info-label"><?php echo e(__('filament.end_date')); ?>:</div>
    ...
    <div class="section">
        <h2><?php echo e(__('filament.description')); ?></h2>
        <p><?php echo e($project->description ?? __('filament.no_description')); ?></p>
    </div>

    <div class="section">
        <h2><?php echo e(__('filament.project_statistics')); ?></h2>
        <div class="stats-grid">
            <div class="stat-box">
                <div class="stat-label"><?php echo e(__('filament.budget')); ?></div>
                <div class="stat-value"><?php echo e(number_format($project->budget ?? 0, 2)); ?> <?php echo e($project->currency ?? 'USD'); ?></div>
            </div>
            <div class="stat-box">
                <div class="stat-label"><?php echo e(__('filament.actual_cost')); ?></div>
                <div class="stat-value"><?php echo e(number_format($project->actual_cost ?? 0, 2)); ?> <?php echo e($project->currency ?? 'USD'); ?></div>
            </div>
            <div class="stat-box">
                <div class="stat-label"><?php echo e(__('filament.profit')); ?></div>
                <div class="stat-value"><?php echo e(number_format($project->profit ?? 0, 2)); ?> <?php echo e($project->currency ?? 'USD'); ?></div>
            </div>
            <div class="stat-box">
                <div class="stat-label"><?php echo e(__('filament.progress')); ?></div>
    ...
    <div class="section">
        <h2><?php echo e(__('filament.tasks')); ?> (<?php echo e($project->tasks->count()); ?>)</h2>
        <table class="tasks-table">
            <thead>
                <tr>
                    <th><?php echo e(__('filament.title')); ?></th>
                    <th><?php echo e(__('filament.status')); ?></th>
                    <th><?php echo e(__('filament.priority')); ?></th>
                    <th><?php echo e(__('filament.due_date')); ?></th>
                </tr>
            </thead>
            <tbody>
    ...
    <div class="footer">
        ...
        <p><?php echo e(config('app.name')); ?> - <?php echo e(__('filament.project_report')); ?></p>
    </div>
</body>
</html>
